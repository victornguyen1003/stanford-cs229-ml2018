...
from ps02cde_posonly import main as p02

import logging

logging.basicConfig(level=logging.INFO, 
                    format='%(asctime)s - %(levelname)s: %(message)s', 
                    handlers=[logging.FileHandler(f"../models/logs/ps1.log")])
...
if args.p_num == 0 or args.p_num == 1:
    p01b(train_path='../data/ds1_train.csv',
         ...
         pred_path='../models/outputs/p01b_pred_1.txt')

    p01b(train_path='../data/ds2_train.csv',
         eval_path='../data/ds2_valid.csv',
         pred_path='../models/outputs/p01b_pred_2.txt')

    p01e(train_path='../data/ds1_train.csv',
         eval_path='../data/ds1_valid.csv',
         pred_path='../models/outputs/p01e_pred_1.txt')

    p01e(train_path='../data/ds2_train.csv',
         eval_path='../data/ds2_valid.csv',
         pred_path='../models/outputs/p01e_pred_2.txt')
...
if args.p_num == 0 or args.p_num == 2:
    p02(train_path='../data/ds3_train.csv',
        ...
        pred_path='../models/outputs/p02X_pred.txt')
